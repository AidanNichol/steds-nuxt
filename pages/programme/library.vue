...
<div class="libraryPage">
  <div class="navBars">
    <div class="searchBy">
      <div @click="showByYear=true"><img :class="{inactive: !showByYear}" src="~/assets/image/searchByDate.jpg"></div>
      <div @click="showByYear=false"><img :class="{inactive: showByYear}" src="~/assets/image/searchByRegion.jpg"></div>
    </div>
  ...
  <div class="center">
    ...
    <div class="searchBy" v-show="curWalk">
      ...
      <div @click="showMap=true"><img :class="{inactive: !showMap}" src="~/assets/image/viewMap.jpg"></div>
      <div @click="showMap=false"><img :class="{inactive: showMap}" src="~/assets/image/viewProfiles.jpg"></div>
    ...
    <RouteDetails v-if="curWalk&&!showMap" :walkId="curWalk" :key="'P'+curWalk"/>
...
import RouteDetails from '~/pages/programme/walkDetails';
...
export default {
  layout: 'full',
  mixins: [WalksMixin],
  components: { NavBarByRegion, NavBarByYear, banner, RouteDetails, ShowMap },
  data() {
    return {
      curWalk: null,
      // curWalkBlock: null,
